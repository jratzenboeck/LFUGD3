...
We tuned the "number of neighbors" ($ k $) parameter to get the best RMSE. Table \ref{tab:late_fusion_results} in section \ref{sec:results} shows different evaluated configurations along with their RMSE value.
