from ibcf.item_based_collaborative_filtering import IBCF
from ibcf.item_based_collaborative_filtering import similarity_pearson
from ibcf.item_based_collaborative_filtering import similarity_cosine
...
rmse = IBCF.cross_validate('../data/shuffled.training.dat',
                           k=1,
...
# Prediction
'''ibcf = IBCF(k=2, similarity=similarity_pearson)
ibcf.load_dataset('../data/lecture.training.dat')
ibcf.train()
ibcf.save_model('../data/model_sim{}.csv'.format(ibcf.similarity.__name__))
ibcf.load_model('../data/model_sim{}.csv'.format(ibcf.similarity.__name__))
